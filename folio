...
<body oncontextmenu="return false">
    <header class="header" id="header">
      <nav class="nav container">
        <a href="#" class="nav__logo">Tejasree</a>
        ...
        <div class="home__container container grid">
          <div class="home__content grid">
            <div class="home__social">
              <a
                href="utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app"
                target="_blank"
            ...
            <div class="home__data">
              <h1 class="home__title">Hi, Tejasree</h1>
              <h3 class="home__subtitle">
                Computer Science Engineering Student
              </h3>
              <p class="home__description">
                A third-year undergraduate engineering student at
                <strong>Gitam University</strong>, Vishakapatnam.
              </p>
              ...
              <div class="skills__list grid">
                <div class="skills__data">
                  <div class="skills__titles">
                    ...
                    <span class="skills__nuber">66%</span>
                  </div>
                  <div class="skills__bar">
          ...
          <div class="qualification__sections">
            ...
            >
              ...
              <div class="qualification__data">
                <div>
                  <h3 class="qualification__title">Timpany School</h3>
                  <span class="qualification__subtitle"
                    >CBSE <br />High School</span
                  >
                      ...
                      <ul class="services__modal-services grid">
                        ...
                        <li class="services__modal-service">
                          <i
                            class="uil uil-check-circle services__moda-icon"
                          ></i>
                          <p>Came runners up in inter-school Throw Ball</p>
                        </li>
                      </ul>
                    </div>
                  </div>
              ...
              <div class="qualification__data">
                ...
                <div>
                  ...
                  <span class="qualification__subtitle"
                    >Intermediate <br />Narayana College</span
                  >
                  <div class="qualification__calender">
                    <i class="uil uil-calendar-alt"></i>
                    - 2021
                    ...
                    <div class="services__modal-content">
                      ...
                      <ul class="services__modal-services grid">
                        <li class="services__modal-service">
                          ...
                          ></i>
                          <p>
                            Studying core subjects of programming like Web applications, Embedded
                            systems, Compiler Design, Programming with Python, Operating
                        ...
                        <li class="services__modal-service">
                          <i
                            class="uil uil-check-circle services__modal-icon"
                          ></i>
                          <p>Scored an aggregate of 7.50 CGPA till now.</p>
                        </li>
                        <li class="services__modal-service">
                          <i
                            class="uil uil-check-circle services__modal-icon"
                          ></i>
                          <p>
                            Took part in blood donation camp and other
                             NSS activities as a volunteer.
                          </p>
                        </li>
                      </ul>
                    </div>
      ...
      <section class="contact section" id="contact">
        ...
        <div class="contact__container container grid">
          <div>
            <div class="contact__information">
              ...
              <div>
                ...
                <span class="contact__subtitle"
                  ><a href="tel:9398874758"></a>9398874758</span
                >
              </div>
            </div>
            ...
            <div class="contact__information">
              ...
              <div>
                ...
                <span class="contact__subtitle"
                  >tejasreesatya02@gmail.com</span
                >
              </div>
            </div>
            ...
            <div class="contact__information">
              ...
              <div>
                ...
                <span class="contact__subtitle"
                  >Vishakapatnam, Andhra Pradesh, India</span
                >
              </div>
            </div>
          </div>
          ...
          <form action="" class="contact__form grid">
            ...
            <div>
              <a
                href=" mailto: tejasreesatya02@gmail.com?subject=Testing out mailto! &body=This is only a test!"
    ...
    <footer class="footer">
      <div class="footer__bg">
        <div class="footer__container container grid">
          <div>
            <h1 class="footer__title">Tejasree</h1>
          ...
          <div class="footer__socials">
            <a
              href="https://www.instagram.com/tejashree_satya?igsh=MXY5NG1nMTA0azlx&utm_source=qr"
            ...
            <a
              href="https://www.linkedin.com/in/tejasree-satya-8a0252294?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app             
 target="__blank"
              class="footer__social"
            >
        ...
        <p class="footer__copy">&#169; Tejasree. All right reserved</p>
      </div>
    </footer>
